...
function LoadGrid(url) {
	...
	setTimeout(function() {
		...
		var source = {
			...
			datafields: [
				{ name: 'FormStructureElementGUID', display: 'FormStructureElementGUID', type: 'string' },
		...
		$("#jqxgrid").jqxGrid({
			...
			enabletooltips: true,
			columns: [
				{ text: 'FormStructureElementGUID', datafield: 'FormStructureElementGUID', hidden: true },
