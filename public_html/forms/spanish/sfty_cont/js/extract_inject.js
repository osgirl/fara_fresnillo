...
var tableConfig   = {"tableSchema":"fara","tableName":"SafetyContact"};
...
function postToDb()
{
	...
	//atob to decode
	jsonData.documentConfig = {"FormId": 6, "CreatorId":1, "DocumentName":"Fresnillo Safety Contact", "DisplayName":"Safety Contact", "doc_json":btoa(formValues) };
	jsonData.formConfig     = {"FormId": 6, "Site": 2, "Crew":"1", "Department":"1", "UserId": 2};
